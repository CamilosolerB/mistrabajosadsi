...
p2=parseInt(prompt("Indique el valor del kilo de gambas"));
    function menu(pers,p1,p2){
        var arr,gam,varr,vgam,total,Mos;
    ...
    Mos = ("En la paella se fue un total de "+arr+" kilos de arroz y " +gam+" kilos de gambas, si hablamos de precio, equivale $"+varr+" el arroz y $"+vgam+"las gambas, dando un total de "+total)
    
        return Mos;
}

    alert(menu(pers,p1,p2));