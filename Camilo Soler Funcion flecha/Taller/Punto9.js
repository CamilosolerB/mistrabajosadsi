...
p2=parseInt(prompt("Indique el valor del kilo de gambas"));
    ...
    alert("En la paella se fue un total de "+arr+" kilos de arroz y " +gam+" kilos de gambas, si hablamos de precio, equivale $"+varr+" el arroz y $"+vgam+"las gambas, dando un total de "+total)
    }
