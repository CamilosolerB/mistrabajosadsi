...
public class vistausu extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Tabla usuarios");
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 10, 240, -1));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(vistausu.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
